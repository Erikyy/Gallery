...
class Post(models.Model):
    ...
    post_image = models.ImageField(blank=False, upload_to=get_folder, default='default.jpg')
...
class Profile(models.Model):
    ...
    profile_image = models.ImageField(upload_to=get_folder, default='default.jpg', blank=True)
